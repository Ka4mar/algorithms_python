...
def check_1(lst_obj):
    ...
    Сложность: Линейная сложность Алгоритма. О(1N)
    """
    lst_to_set = set(lst_obj)  # О(len(...)) - Линейная сложность
...
def check_2(lst_obj):
    ...
    Сложность: О(2N^2) Квадратичная сложность
    """
    for j in range(len(lst_obj)):          # О(N) - Линейная сложность
...
def check_3(lst_obj):
    ...
    Сложность: Квадратичная сложность
    """
    lst_copy = list(lst_obj)                 # О(len(...)) - Линейная сложность
    lst_copy.sort()                          # O(N Log N) - Линейно Логарифмическая
    for i in range(len(lst_obj) - 1):        # O(N) - Линейная сложность
        if lst_copy[i] == lst_copy[i+1]:     # O(N) - Линейная сложность
            return False                     # O(1) - Константная сложность
    return True                              # O(1) - Константная сложность
